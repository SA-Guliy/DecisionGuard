...
### 7.7 Metrics V2 Advisory Snapshot

The v2 metrics pack (calibration, retrieval grounding, scenario reliability, decision diagnostics) is tracked in advisory-first mode.
